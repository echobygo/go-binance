...
[![GoDoc](https://godoc.org/github.com/echobygo/go-binance?status.svg)](https://godoc.org/github.com/echobygo/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/echobygo/go-binance)](https://goreportcard.com/report/github.com/echobygo/go-binance)
...
```shell
go get github.com/echobygo/go-binance
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/echobygo/go-binance/v1
```
...
```golang
import (
    "github.com/echobygo/go-binance"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/echobygo/go-binance) for full references.
...
```go
import (
    "github.com/echobygo/go-binance/futures"
)
...
```go
import (
    "github.com/echobygo/go-binance/delivery"
)
